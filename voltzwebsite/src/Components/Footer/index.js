        ...
        <div className="container-fluid top-footer-content ">
          <div className="foot d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center justify-content-center ">
              <img className="footer-img" src={PhoneImg2} alt="download" />
            </div>

            {/* <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6"> */}
            <div className="top-footer-text">
              <div className="top-footer-text1">
                Manage your smart device from your mobile
              </div>
              <div className="top-footer-text2 mt-3">
                Download the app to manage your projects, keep track of the
                progress and complete tasks without procastinating.
              </div>
              <div className="mt-4 get">Get the App</div>
              <div className="auth-store mt-2 d-flex">
                <div>
                  <img class="googlebtn " src={google} alt="App Store" />
                </div>
                <div>
                  <img class="googlebtn " src={apple} alt="App Store" />
                </div>
              </div>
            </div>
          </div>
