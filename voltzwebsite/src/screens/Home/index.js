    ...
    <div>
            ...
            <div className="left-hero-content">
              <div className="left-hero-content-heading">
                ...
                <div className="left-hero-para2 mt-3">
                  Voltz Control is helping the users to achieve the best and
      ...
      <div className="second-content">
        <div className="phone-container">
          <div className="d-flex align-items-center justify-content-center">
            {" "}
            <img className="middlephone" src={PhoneImg} alt="App Store" />
          </div>
          <div className="temperature bg-white rounded-4 px-3 py-3 shadow-lg d-flex">
            <div className="temperature-icon px-3  d-flex align-items-center justify-content-center rounded-4 mx-2">
              <i class="fa-solid fa-temperature-full text-white fs-3"></i>
            </div>
            <div>
          ...
          <div className="alarm bg-white rounded-4 px-3 py-3  shadow-lg d-flex">
            <div className="alarm-icon px-3  d-flex align-items-center justify-content-center rounded-4 mx-2">
              <i class="fa-solid fa-house-user text-white fs-3"></i>
            </div>
            <div className="mx-2">
              Alarm <br /> system
            </div>
          ...
          <div className="spotlight bg-white rounded-4 px-3 py-3 shadow-lg d-flex">
            <div className="spotlight-icon px-3  d-flex align-items-center justify-content-center rounded-4 mx-2">
              <i class="fa-sharp fa-solid fa-lightbulb text-white fs-3"></i>
            </div>
            <div>
              Smart <br /> spotlights
            </div>
          ...
          <div className="detector bg-white shadow-lg rounded-4 px-3 py-3 shadow-lg  d-flex">
            <div className="detector-icon px-3  d-flex align-items-center justify-content-center rounded-4 mx-2">
              <i class="fa-solid fa-fire text-white fs-3"></i>
            </div>
            <div>
              Smoke <br /> detector
            </div>
      ...
      <div className="container features-content mt-5">
        <div className="feature-container d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="enhance-feature text-center">
            Enhance Your Space <br />
            with The Amazing <br /> Features
          </div>
        </div>
        ...
        <div className="row feature-row mt-4">
            ...
            <div className="feature-container-detailed ">
              <div className="feature-img-container bg-black">
                <div className="feature-img d-flex align-items-center justify-content-center">
                  {" "}
                  <img className="leftphone " src={LeftImg} alt="App Store" />
                </div>
              </div>

              <div className="feature-text mt-3">01</div>
              <div className="feature-text2 mt-2">
                Monthly summary and <br />
                statistics right on <br /> your fingertips
              </div>
              <div className="feature-text3 mt-2">
                Voltz helps you to understand your monthly <br />
                summary, spending, and usage better. <br />
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 ">
            <div className="feature-container-detailed ">
              ...
              <div className="feature-textt2 mt-2">
                Fully control your
                <br />
                home by rooms or by
                <br /> the devices
              ...
              <div className="feature-text3 mt-2">
                Voltz gives you detailed information of any
                <br />
                devices in any room you have. You also have <br /> a full
                control of them.
              </div>
            </div>
          </div>
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 ">
            <div className="feature-container-detailed ">
              <div className="feature-img-container bg-black">
                <div className="feature-img d-flex align-items-center justify-content-center">
                  {" "}
                  <img className="rightphone" src={RightImg} alt="App Store" />
                </div>
              </div>
              ...
              <div className="feature-text2 mt-2">
                Automate everything
                <br />
                and let us get all things
                <br />
                ready for you
              </div>
              <div className="feature-text3 mt-2">
                Voltz newest feature, we help you to create <br />
                an automton to autom your work, we <br />
                Will get anthing ready for you
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container about-content mt-5">
        <div className="d-flex align-items-center justify-content-center">
          <div className="about-text-container">
            ...
            <div className="about-text-main text-center">
              The Best Smart Home App You Can Get
            </div>
          </div>
        ...
        <div className="text-center mt-3">
          A single experience that supports your whole home
        </div>
        ...
        <div className="row d-flex align-items-center justify-content-center">
          ...
          <div className="col-first col-sm-10 col-md-5 col-lg-4 col-xl-3 ">
            <div className="testimonial-heading">
              <div className="testimonial-heading-text d-flex ">
                <i class="fa-solid fa-quote-left"></i>Real Stories from <br />{" "}
                Real customers
              </div>
              <div className="testimonial-heading-text2">
                Get inspired by our client stories
              </div>
            </div>
            <div className="w-100 h1 bg-white shadow-lg p-5">
              <div className="review-text d-flex">
                <i class="fa-solid fa-quote-left"></i>
                <div className="reviews-text1">
                  We found Voltz <br /> through audiophile channels <br /> but
                  have found so many <br /> other uses. We've turned <br />
                  hedge fund managers on to some of the tools. We've sent our
                  staff acoustian the 'white noise' files which he seemingly
                  uses
                </div>
              </div>
              ...
              <div className="review-text d-flex mt-5">
                <div className="reviewimg">
                  <img className="reviewimage" src={Man1} alt="App Store" />
                </div>
            ...
            <div className="row ">
              <div className="mt-5 col-sm-12 col-md-11 col-lg-11 ">
                <div className="w-100 bg-white shadow-lg ht p-5">
                  <div className="review-text d-flex">
                    <i class="fa-solid fa-quote-left"></i>
                    <div className="reviews-text1">
                      We found Voltz when we were searching for a way to gather
                      unbiased review data when publishing our articles.
                    </div>
                  </div>
                  <div className="review-text d-flex mt-5">
                    <div className="reviewimg">
              ...
              <div className=" mt-5 col-sm-12 col-md-10 col-lg-10 ">
                <div className="w-100 bg-white shadow-lg p-5 ht">
                  ...
                  <div className="review-text d-flex mt-5">
                    <div className="reviewimg">
                      <img className="reviewimage" src={Man2} alt="App Store" />
                    </div>
                    <div className="review-text-rev">
                      <div>Jerry Colliano</div>
                      <div>Home Theater Review</div>
